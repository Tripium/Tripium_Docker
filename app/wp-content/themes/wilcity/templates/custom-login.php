...
if ( User::isUserLoggedIn() && !General::isElementorPreview() ){
        ...
        <div class="wil-content">
            ...
            <section class="wil-section pt-0 pb-0">
                <div class="row">
                    ...
                    <?php
                    $showFooterNavMenu = apply_filters('wilcity/filter/custom-login/show-footer-nav-menu', true);
                    if (has_nav_menu($menuLocation) && $showFooterNavMenu) : ?>
