...
namespace MyshopKitDesignWizard\Shared\Middleware;



use Exception;
use MyshopKitDesignWizard\Illuminate\Message\MessageFactory;
use MyshopKitDesignWizard\Shared\Middleware\Middlewares\IMiddleware;
...
trait TraitMainMiddleware
{
    ...
    {
        $aAllMiddleware = include(MYSHOPKIT_DW_PATH . 'src/Shared/Middleware/Configs/Configuration.php');
