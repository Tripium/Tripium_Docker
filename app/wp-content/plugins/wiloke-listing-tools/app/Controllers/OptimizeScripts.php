...
class OptimizeScripts extends Controller
{
    ...
    private function buildScriptCode($isFocus = false)
    {
        ...
        $aGlobal = [
            ...
            'uploadType'                  => $aThemeOptions['addlisting_upload_img_via'] ?? '',
            ...
            'mapCenter'                   => $aThemeOptions['map_center'] ?? '',
            ...
            !ClaimController::isPaidClaim() ? 'no' : 'yes',
        ...
        $aInlineGlobal = [
            ...
            "addListingAllowable"         => GetWilokeSubmission::isEnable("toggle_become_an_author") == "enable" ? "yes" : "no"
        ];
