...
class UserModel
{
    ...
    public static function staticFindPlanByPostType($userID, $planID)
    {
    ...
    public static function getSpecifyUserPlanType($planType, $userID = null, $isFocus = true)
    {
    ...
    {
        $this->newPlanID = GetWilokeSubmission::getOriginalPlanId($planID);
        return $this;
    }

    public function setOldPlanID($planID)
    {
        $this->oldPlanID = GetWilokeSubmission::getOriginalPlanId($planID);
        return $this;
    }
    ...
    public function deleteUserPlan($planID)
    {
        ...
        if (!isset($aPlans[$this->planType][$this->planID])) {
            return true;
        }
    ...
    public function setUserPlan()
    {
        ...
        FileSystem::logSuccess(
            "User ID: {$this->userID} has been updated new plan. Plan ID: {$this->planID} " . json_encode($aPlans),
            __CLASS__,
            __METHOD__
        );
        return true;
