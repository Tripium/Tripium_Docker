...
class EventSkeleton extends AbstractSkeleton
{
    ...
    public function getCalendar()
    {
        ...
        $aEventData['oStarts'] = [
            'date' => Time::toDateFormat($aEventData['startTimestamp']),
            'hour' => date_i18n($newTimeFormat, $aEventData['startTimestamp'])
        ];

        $aEventData['oEnds'] = [
            'date' => Time::toDateFormat($aEventData['endTimestamp']),
            'hour' => date_i18n($newTimeFormat, $aEventData['endTimestamp'])
        ];
        $aEventData['oOccur'] = [
            'frequency' => $frequency
        ];
