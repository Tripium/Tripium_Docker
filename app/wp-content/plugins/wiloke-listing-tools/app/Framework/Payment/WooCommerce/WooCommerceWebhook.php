...
//        );
        ...
        add_action('woocommerce_subscription_status_active', [$this, 'subscriptionCreated']);
...
//        }
    ...
    {
        if (method_exists("WC_Subscription", "get_next_payment_date")) {
            $this->nextBillingDateGMT = Time::timestampUTCNow($oSubscription->get_next_payment_date());
        } else {
    ...
    private function getPaymentIDs($orderID = '')
    {
        ...
        $this->oOrder = new WC_Order($orderID);
        $this->aPaymentIDs = PaymentModel::getPaymentIDsByWooOrderID($orderID);
    }
